...
var update = __webpack_require__(11)("4895ade5", content, false, {});
    ...
    methods: {
        parseResources: function parseResources(rows) {
            ...
            rows.forEach(function (row) {
                map[row.id.value] = {
                    ...
                    icon: _this.isActiveIcon(_this.attrValue(row, 'is_active'), true),
                    parentText: _this.attrValue(row, 'parent'),
                    parentId: _this.attrValue(row, 'parent', 'belongsToId'),
                    slug: _this.attrValue(row, 'slug'),
                    children: [],
                    opened: true
                };
            });
        ...
        fetchData: function fetchData() {
            ...
            Nova.request().get('/nova-api/' + this.resource).then(function (res) {
                _this3.currentNode = null;
                _this3.parseResources(res.data.resources);
                _this3.updateRetrievedAt();
            }).catch(function (err) {
                console.error(err);
        ...
        setIconState: function setIconState() {
            ...
            Array.isArray(children) && children.forEach(function (child) {
                child.icon = _this4.isActiveIcon(child.is_active, parentActive);
                _this4.setIconState(child.children, child.icon === 'enabled');
            });
        },
        ...
        deleteNode: function deleteNode() {
            ...
            Nova.request().post('/nova-api/' + this.resource + '?resources[]=' + this.currentNode.id, this.formData(this.currentNode, {}, "DELETE")).then(function (res) {
                var parent = _this5.parents[_this5.currentNode.parentId];
                if (parent) parent.children.splice(parent.children.indexOf(_this5.currentNode), 1);else {
                    _this5.$delete(_this5.parents, _this5.currentNode.id);
                    _this5.$delete(_this5.tree, _this5.currentNode.id);
                }
                _this5.currentNode = null;
            }).catch();
        },
        toggleNode: function toggleNode() {
            ...
            this.updateNode(node, {
                ...
                _this6.$toasted.show('Failed toggling resource!', { type: 'error' });
            });
        },
        orderNode: function orderNode(dir) {
            ...
            this.updateNode(node, {
                ...
                _this7.$toasted.show('Failed changing order', { type: 'error' });
            });
        },
        mergeResponse: function mergeResponse(res) {
            if (res.id && res.resource) {
                ...
                } else node.icon = this.isActiveIcon(is_active, false);
          ...
          _c("div", { staticClass: "card mb-6 py-3 px-6" }, [
            ...
            _vm.node.parentText
              ? _c("div", { staticClass: "flex border-b border-40" }, [
                  ...
                  _c("div", { staticClass: "w-3/4 py-4 break-words" }, [
                    _c("p", { staticClass: "text-90" }, [
                      _vm._v(_vm._s(_vm.node.parentText))
                    ])
                  ])
                ])
              : _vm._e(),
                ...
                [
                  _c("checkbox", {
                    ...
                    attrs: {
                      id: _vm.is_active,
                      name: _vm.Active,
                      checked: _vm.node.is_active,
                      disabled: typeof _vm.node.is_active === "string"
                    },
                    on: {
                      input: function($event) {
                        return _vm.$emit("onToggle")
                      }
                    }
                  })
                ],
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-1/4 py-4" }, [
      _c("h4", { staticClass: "font-normal text-80" }, [_vm._v("Parent")])
    ])
  },
  function() {
    var _vm = this
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-1/4 py-4" }, [
      _c("h4", { staticClass: "font-normal text-80" }, [_vm._v("Active")])
    ])
  }
]
...
var render = function() {
  ...
  return _c("loading-view", { attrs: { loading: _vm.loading } }, [
    _c(
      ...
      [
        _c("v-jstree", {
          attrs: { data: _vm.tree, draggable: "true", "whole-row": "" },
                ...
                "router-link",
                {
                  ...
                  attrs: {
                    to:
                      "/resources/" +
                      _vm.resource +
                      "/new?viaResource=&viaResourceId=&iaRelationship=",
                    dusk: "create-button"
                  }
                },
                [
